...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Franco Camborda"
    user-mail-address "f.camborda@outlook.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/franco/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/franco/bin" "/profile/bin" "/Users/franco/.npm-packages/bin" "/Users/franco/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
